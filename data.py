...
from tensorflow.keras.layers import Embedding, LSTM, SimpleRNN, GRU
...
DATA_DIR = "Data/Train/Quick_Train/"
...
DATA_DIR = "Data/Train/Long_Train/"
if not os.path.exists(DATA_DIR):
    os.makedirs(DATA_DIR)
np.save(TEMP_DATA_DIR + "/x_news_train.npy", x_news_train)
np.save(TEMP_DATA_DIR + "/x_price_train.npy",x_price_train)
...
DATA_DIR = "Data/Train/Best_Train/"
if not os.path.exists(DATA_DIR):
    os.makedirs(DATA_DIR)
np.save(TEMP_DATA_DIR + "/x_news_train.npy", x_news_train)
np.save(TEMP_DATA_DIR + "/x_price_train.npy",x_price_train)
...
DATA_DIR = "Data/Validation/Quick_Validate/"
if not os.path.exists(DATA_DIR):
    os.makedirs(DATA_DIR)
